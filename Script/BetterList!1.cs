...
public class BetterList<T>
{
    ...
    {
        T[] array = (this.buffer == null) ? new T[0x20] : new T[Math.Max(this.buffer.Length << 1, 0x20)];
    ...
    {
        return new  c__Iterator1 { f__this = (BetterList<T>) this };
    }
    ...
    [CompilerGenerated]
    private sealed class  c__Iterator1 : IEnumerator, IDisposable, IEnumerator<T>
    {
        internal T current;
        internal int PC;
